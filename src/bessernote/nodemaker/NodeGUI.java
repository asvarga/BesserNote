...
//    double ty;
    ...
    public NodeGUI(double spacing) {
        ...
        combo.getItems().addAll("Pane", "WrapPane", "ScrollPane", "Circle", "TextArea", "TabPane", "FlashCard", "Image", "Deck");
        ...
        show1.addGUI("Image", new ImageGUI(_top, spacing));
        show1.addGUI("Deck", new DeckGUI(_top, spacing));
